...
Rx=u_r*m*g/2*(sign(x1r_dot)+sign(x2r_dot));
Fy=u_l*m*g/2*(sign(y1r_dot)+sign(y3r_dot));
Mr=u_l*a*m*g/2*(sign(y1r_dot)-sign(y3r_dot))+u_r*L*m*g/2*(sign(x2r_dot)-sign(x1r_dot));
