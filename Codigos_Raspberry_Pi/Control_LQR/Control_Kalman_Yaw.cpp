...
float rev_vel=0.0;
float rev_theta=0.0;
float theta,theta_a,w_der_a,w_iz_a;
...
// INICIO LQR
	...
	theta=((w_der_a-w_iz_a)*0.00600096)+theta_a;
...
//------------------ LQR Fin ----------------------------------------------------------
	...
	conver(motor_1,motor_2,rev_vel,rev_theta,theta,0.0,roll,pitch,yaw2);
...
//        printf("impirmir PWM AUTO2= %i\n",motor_2);
	...
	//conver(motor_1,motor_2,0.0,0.0,0.0,gx2,gy2,gz2,yaw);
	//conver_motor();
/*
	motor_1=map(motor_1,0,-100,1480,2300);
	motor_2=map(motor_2,0,-100,1480,2300);
